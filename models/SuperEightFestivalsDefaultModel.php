 ...
 * @package SimplePages
 */
class SuperEightFestivalsDefaultModel extends Omeka_Record_AbstractRecord implements Zend_Acl_Resource_Interface
{
    ...
    {
        return 'SuperEightFestivals_DefaultModel';
    }
}
