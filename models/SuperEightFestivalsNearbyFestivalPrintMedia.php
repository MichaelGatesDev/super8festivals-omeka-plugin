...
class SuperEightFestivalsNearbyFestivalPrintMedia extends Super8FestivalsRecord
{
    // ======================================================================================================================== \\

    public ?int $nearby_festival_id = null;
    ...
    public function get_db_foreign_keys()
    {
        return array_merge(
            array(
                "FOREIGN KEY (`nearby_festival_id`)     REFERENCES {db_prefix}{table_prefix}nearby_festivals(`id`)      ON DELETE CASCADE",
    ...
    public function update($arr, $save = true)
    {
        ...
        if (isset($arr['festival'])) {
            ...
            if (!$festival) throw new Exception("{$cname} is not associated with a SuperEightFestivalsNearbyFestival");
    ...
    /**
     * @param $search_id
     * @return SuperEightFestivalsNearbyFestivalPrintMedia|null
     */
    ...
    /**
     * @return SuperEightFestivalsNearbyFestivalPrintMedia[]
     */
    ...
    {
        return SuperEightFestivalsNearbyFestival::get_by_id($this->nearby_festival_id);
    }
