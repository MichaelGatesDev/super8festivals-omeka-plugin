    ...
    <?php foreach ($federation_photos as $photo): ?>
        <li class="photo">
            ...
            <p style="text-align: center">
                <a class="button blue" href="/admin/super-eight-festivals/federation/photos/<?= $photo->id; ?>/edit">Edit</a>
                <a class="button red" href="/admin/super-eight-festivals/federation/photos/<?= $photo->id; ?>/delete">Delete</a>
            </p>
        </li>
    <?php endforeach; ?>
</ul>